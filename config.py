...
def get_args():
    parser = argparse.ArgumentParser(description='SANFlow')
    ...
    parser.add_argument('-dec', '--dec-arch', default='sanflow', type=str, metavar='A')
    ...
    parser.add_argument('--workers', default=2, type=int, metavar='G',
